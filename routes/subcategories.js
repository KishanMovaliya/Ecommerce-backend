...
router.post("/create/:id", async(req,res) =>{
    ...
    const subcategoryExist = await Subcategory.findOne({ subcategory: req.body.subcategory });
    if (subcategoryExist) return res.status(400).json({ msg: "Category Already Exist" });
